...
export default async function ServicesDetailPage({
  ...
  params: Promise<{ id?: string }>;
    ...
    return (
        <article className="w-full flex flex-col gap-4 bg-white">
            <div className="px-16 py-8">
                <BreadCrumb breadcrumb={[
                    {title: t("breadcrumb.services"), href: routes.services.list},
                    {title: t("breadcrumb.detail"), href: routes.services.detail(service.id)},
                    ]}
                />
            </div>
