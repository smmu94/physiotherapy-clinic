          ...
          <>
            <li className='flex items-center'>
              <Button
                ...
                className='h-auto min-w-0 stroke-inherit p-0 text-gray hover:text-dark'
                onClick={isCollapsed => {
...
const DefaultSeparator: Record<string, ReactNode> = {
  chevron: <ChevronIcon className='size-5 -rotate-90 stroke-neutral-medium' />,
  slash: '/',
};

function BreadcrumbSeparator({ separator }: Pick<BreadcrumbsProps, 'separator'>) {
  return (
    <li role='presentation' aria-hidden className='inline-flex items-center text-neutral-medium'>
